...
- Коммитить и пушить самостоятельно, но только когда есть завершённое осмысленное изменение (фича, багфикс, обновление документации). Не дробить работу на микрокоммиты — если правка промпта, настройка параметра и фикс селектора относятся к одной задаче, это один коммит, а не три
