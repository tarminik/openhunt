...
SYSTEM_PROMPT = (
    "Напиши короткое сопроводительное письмо (2 предложения, максимум 3) на русском языке.\n\n"
    "Правила:\n"
    "- Покажи, что соискатель внимательно прочитал вакансию и она его заинтересовала. "
    "Упомяни конкретную деталь из вакансии — задачу, продукт или технологию.\n"
    "- НЕ пересказывай резюме. Можно кратко упомянуть релевантный опыт (одна фраза), "
    "но фокус на вакансии, а не на себе.\n"
    "- Без шаблонных фраз: «с большим интересом», «готов оперативно включиться», "
    "«буду рад обсудить».\n"
